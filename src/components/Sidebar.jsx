...
const icons = {
  dashboard:     'M3 3h7v7H3V3zm11 0h7v7h-7V3zM3 14h7v7H3v-7zm11 3.5a3.5 3.5 0 1 0 7 0 3.5 3.5 0 0 0-7 0z',
  ...
  support:       'M12 22C6.477 22 2 17.523 2 12S6.477 2 12 2s10 4.477 10 10-4.477 10-10 10zM9.09 9a3 3 0 0 1 5.83 1c0 2-3 3-3 3M12 17h.01',
    ...
    <>
      ...
      >
        ...
        <div className="flex items-center gap-2.5 px-4 py-5 border-b border-gray-200 dark:border-[#1C1C1C]">
          <div className="w-8 h-8 rounded-full bg-[#0CC8A8] flex items-center justify-center flex-shrink-0">
            <svg viewBox="0 0 24 24" className="w-4 h-4 text-black" fill="currentColor">
              <path d="M12 2L4 6v6c0 5.55 3.84 10.74 8 12 4.16-1.26 8-6.45 8-12V6l-8-4z" />
            </svg>
          </div>
          <span className="font-bold text-lg text-gray-900 dark:text-white tracking-tight">aps</span>
        ...
        <div className="px-3 py-4 border-t border-gray-200 dark:border-[#1C1C1C] space-y-2">
          ...
          <div className="flex items-center gap-3 px-3 py-2 rounded-lg hover:bg-gray-100 dark:hover:bg-white/5 cursor-pointer transition-colors">
            <div className="w-8 h-8 rounded-full bg-gradient-to-br from-orange-400 to-pink-500 flex-shrink-0 flex items-center justify-center text-white text-xs font-bold">
              A
            </div>
            <div className="flex-1 min-w-0">
              <p className="text-xs font-semibold text-gray-900 dark:text-white truncate">admin@edu.com</p>
              <p className="text-[11px] text-gray-400 truncate">Security Lead</p>
            </div>
